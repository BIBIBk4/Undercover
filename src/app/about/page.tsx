...
export default function Page() {
    return (
        <>
            <h1 className="text-center font-bold text-3xl">À propos de ce site</h1>
            <p className="mt-20">Bienvenue sur mon premier site avec Nextjs! Ce projet représente mon tout premier pas dans l&apos;univers de Next.js. 
                Après avoir acquis des connaissances théoriques sur ce puissant framework, j&apos;ai décidé de les mettre en pratique 
